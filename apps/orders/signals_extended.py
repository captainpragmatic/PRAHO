...
def handle_order_domain_provisioning(sender: type[Order], instance: Order, created: bool, **kwargs: Any) -> None:
    ...
    try:
        ...
        domain_items = instance.items.filter(
            product_type='domain',
...
def handle_service_group_management(sender: type[OrderItem], instance: OrderItem, created: bool, **kwargs: Any) -> None:
    ...
    try:
        ...
        bundle_items = order.items.filter(
            product_type='hosting',
            config__bundle_group__isnull=False
...
@receiver(post_save, sender=OrderItem)  
def handle_failed_provisioning_ticket_creation(sender: type[OrderItem], instance: OrderItem, created: bool, **kwargs: Any) -> None:
    """
    ...
    try:
        ...
        if (instance.provisioning_status == 'failed' and 
            old_status != 'failed' and 
