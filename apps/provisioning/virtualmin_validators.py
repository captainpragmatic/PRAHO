...
class VirtualminValidator:
    ...
    def validate_username(username: str) -> str:
        ...
        reserved_usernames = [
            ...
            'test', 'guest', 'daemon', 'nobody', 'www-data'
        ]
    ...
    def validate_api_username(username: str) -> str:
        ...
        reserved_api_usernames = [
            'admin', 'administrator', 'www', 'mail', 'ftp',
            'test', 'guest', 'daemon', 'nobody', 'www-data'
        ]
    ...
    def validate_virtualmin_program(program: str) -> str:
        ...
        allowed_programs = {
            # Domain management
            'create-domain', 'delete-domain', 'list-domains', 'modify-domain',
            'enable-domain', 'disable-domain', 'get-domain',
            
            # Alias management
            'create-alias', 'delete-alias', 'list-aliases',
            
            # Subdomain management
            'create-subdomain', 'delete-subdomain', 'list-subdomains',
            
            # User management
            'create-user', 'delete-user', 'list-users', 'modify-user',
            
            # Database management
            'create-database', 'delete-database', 'list-databases',
            
            # SSL management
            'request-letsencrypt-cert', 'install-cert', 'list-certs',
            
            # DNS management
            'create-dns', 'delete-dns', 'list-dns', 'modify-dns',
