...
urlpatterns = [
    ...
    path(
        'api/public/',
        views.public_settings_api,
        name='public_settings_api'
    ),
    
    # Health check
    path(
        'api/health/',
        views.settings_health_check,
        name='health_check'
    ),
    ...
    path(
        'api/<str:key>/',
        views.SettingsAPIView.as_view(),
        name='setting_detail_api'
    ),
    
    # Category-specific settings
    path(
        'api/category/<str:category_key>/',
        views.category_settings_api,
        name='category_settings_api'
    ),
    ...
    path(
        'dashboard/',
        views.SettingsDashboardView.as_view(),
        name='dashboard'
    ),
    ...
    path(
        'manage/',
        views.SettingsManagementView.as_view(),
        name='manage'
    ),
    
    # HTMX partial for category content
    path(
        'manage/category/<str:category_key>/',
        views.category_management_partial,
        name='category_management_partial'
    ),
