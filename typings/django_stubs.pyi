...
class TypedQuerySet(QuerySet[T], Generic[T]):
    ...
    def select_related(self, *fields: Union[str, List[str]]) -> TypedQuerySet[T]: ...
    def prefetch_related(self, *fields: Union[str, List[str]]) -> TypedQuerySet[T]: ...

# Enhanced ModelManager type
class TypedManager(models.Manager[T], Generic[T]):
    def get_queryset(self) -> TypedQuerySet[T]: ...
    def create(self, **kwargs: Any) -> T: ...
    def get_or_create(self, defaults: Optional[Dict[str, Any]] = None, **kwargs: Any) -> tuple[T, bool]: ...
    def update_or_create(self, defaults: Optional[Dict[str, Any]] = None, **kwargs: Any) -> tuple[T, bool]: ...
...
class TypedModelAdmin(ModelAdmin[T], Generic[T]):
    ...
    def has_change_permission(self, request: HttpRequest, obj: Optional[T] = None) -> bool: ...
    def has_delete_permission(self, request: HttpRequest, obj: Optional[T] = None) -> bool: ...
