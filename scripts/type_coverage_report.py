...
class TypeCoverageReporter:
    ...
    def generate_comprehensive_report(self) -> dict[str, Any]:
        ...
        apps = [
            "audit", "billing", "customers", "domains", 
            "integrations", "notifications", "orders", 
            "products", "provisioning", "tickets", "users", "common"
        ]
    ...
    def _generate_recommendations(self, app_reports: list[dict[str, Any]]) -> list[str]:
        ...
        if high_error_apps:
            recommendations.append(
                f"Focus on apps with high type errors: {[app['app'] for app in high_error_apps]}"
            )
