...
from apps.common.validators import (
    ...
    SUSPICIOUS_PATTERNS, MAX_EMAIL_LENGTH, ALLOWED_CUSTOMER_ROLES
)
from apps.common.security_decorators import (
    secure_user_registration, secure_customer_operation, 
    _check_rate_limit, _normalize_response_time,
    monitor_performance
)
from apps.users.services import SecureUserRegistrationService, SecureCustomerUserService
