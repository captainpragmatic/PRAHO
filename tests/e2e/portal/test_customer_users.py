...
def test_customer_profile_using_convenience_helper(monitored_customer_page: Page) -> None:
    """
...
def test_customer_profile_editing(monitored_customer_page: Page) -> None:
    """
...
def test_customer_password_change_workflow(monitored_customer_page: Page) -> None:
    """
...
def test_customer_2fa_setup_access_and_flow(monitored_customer_page: Page) -> None:
    """
...
def test_customer_cannot_edit_other_users(monitored_customer_page: Page) -> None:
    """
...
def test_customer_complete_account_management_workflow(monitored_customer_page: Page) -> None:
    """
...
def test_customer_company_profile_view(monitored_customer_page: Page) -> None:
    """
...
def test_customer_company_profile_edit(monitored_customer_page: Page) -> None:
    """
...
def test_customer_data_export_request(monitored_customer_page: Page) -> None:
    """
...
def test_customer_mfa_management_hub(monitored_customer_page: Page) -> None:
    """
...
def test_customer_mfa_backup_codes(monitored_customer_page: Page) -> None:
    """
...
def test_customer_company_create_redirect(monitored_customer_page: Page) -> None:
    """
...
def test_customer_switch_customer_single_org(monitored_customer_page: Page) -> None:
    """
