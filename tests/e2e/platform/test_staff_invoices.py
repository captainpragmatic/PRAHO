"""
Invoices E2E Tests for PRAHO Platform - Staff/Admin Tests

This module tests staff-side invoices/billing functionality including:
...
Split from tests/e2e/test_invoices_pytest.py (staff portion).
...
def navigate_to_invoices(page: Page) -> bool:
    """
    Navigate to the invoices/billing page on the platform service.
