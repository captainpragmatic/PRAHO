...
test-platform:
	...
	@echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
	@$(PYTHON_PLATFORM_MANAGE) test tests --settings=config.settings.test --verbosity=2 --parallel
...
ifndef MODULES
	...
	@$(PYTHON_PLATFORM_MANAGE) test $(MODULES) --settings=config.settings.test --verbosity=2 --failfast --parallel
