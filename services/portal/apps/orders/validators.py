...
class OrderInputValidator:
    ...
    ALLOWED_CONFIG_KEYS: ClassVar[dict] = {
        ...
        "vps": {"os_type", "server_location", "control_panel", "cpu_cores", "ram_gb", "storage_gb", "backup_frequency"},
        "dedicated": {
            "os_type",
            "server_location",
            "raid_config",
        ...
        "domain": {"privacy_protection", "auto_renew", "transfer_lock"},
        "ssl": {"validation_type", "wildcard", "extended_validation"},
    }
