...
class Order(models.Model):
    ...
    def save(self, *args: Any, **kwargs: Any) -> None:
        """Ensure order has an order number before saving.

        Callers should always supply an order_number generated by
        OrderNumberingService.generate_order_number().  A fallback is
        provided here for legacy test helpers and fixtures that create
        orders directly.
        """
