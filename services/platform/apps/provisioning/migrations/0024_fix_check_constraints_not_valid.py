"""
Zero-downtime fix: recreate all provisioning CHECK constraints with NOT VALID + VALIDATE.
...
_CONSTRAINTS = [
    ...
    (
        "provisioning_servicegroup",
        "service_group_valid_status",
...
class Migration(migrations.Migration):
    ...
    dependencies = [("provisioning", "0023_alter_servicegroup_status_and_more")]
