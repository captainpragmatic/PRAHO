    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rollback_executed', models.BooleanField(default=False, help_text='Whether rollback was attempted after failure', verbose_name='Rollback Executed')),
                ('rollback_status', models.CharField(blank=True, choices=[('', 'Not Applicable'), ('success', 'Rollback Successful'), ('partial', 'Rollback Partially Successful'), ('failed', 'Rollback Failed')], help_text='Status of rollback operation if executed', max_length=20, verbose_name='Rollback Status')),
                ('rollback_details', models.JSONField(blank=True, default=dict, help_text='Details of rollback operations performed')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('management_api_key', models.TextField(blank=True, default='', verbose_name='AES-256-GCM Encrypted API Key')),
                ('management_api_secret', models.TextField(blank=True, default='', verbose_name='AES-256-GCM Encrypted API Secret')),
                ('management_webhook_secret', models.CharField(blank=True, default='', max_length=500, verbose_name='AES-256-GCM Encrypted Webhook Secret')),
                ('api_username', models.CharField(blank=True, default='', max_length=100, verbose_name='Virtualmin API Username')),
                ('_api_password_encrypted', models.TextField(blank=True, default='', verbose_name='AES-256-GCM Encrypted API Password')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['status', 'server_type'], name='provisionin_status_f282fb_idx'), models.Index(fields=['location'], name='provisionin_locatio_a5de11_idx'), models.Index(fields=['primary_ip'], name='provisionin_primary_4a3581_idx')],
            },
        ),
        migrations.CreateModel(
            name='Service',
            fields=[
                ...
                ('status', django_fsm.FSMField(choices=[('pending', 'Pending'), ('provisioning', 'Provisioning'), ('active', 'Active'), ('suspended', 'Suspended'), ('failed', 'Provisioning Failed'), ('terminated', 'Terminated'), ('expired', 'Expired')], default='pending', max_length=20, protected=True, verbose_name='Status')),
                ...
                ('provisioning_task_id', models.CharField(blank=True, max_length=100, verbose_name='Provisioning Task ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('domain_type', models.CharField(choices=[('primary', '🎯 Primary Domain'), ('addon', '+ Add-on Domain'), ('subdomain', '🔗 Subdomain'), ('redirect', '↩️ Domain Redirect'), ('parking', '🅿️ Parked Domain')], default='primary', help_text='How domain is used with service', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_type', models.CharField(choices=[('package', '📦 Hosting Package'), ('cluster', '🔗 Service Cluster'), ('bundle', '🎁 Product Bundle'), ('environment', '🏗️ Environment'), ('reseller', '👥 Reseller Package')], help_text='Type of service group', max_length=20)),
                ('status', django_fsm.FSMField(choices=[('active', '🟢 Active'), ('suspended', '🟡 Suspended'), ('cancelled', '🔴 Cancelled'), ('pending', '⏳ Pending Setup')], db_index=True, default='pending', max_length=20, protected=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('member_role', models.CharField(choices=[('primary', '🎯 Primary Service'), ('dependency', '⚡ Dependency'), ('addon', '🔧 Add-on'), ('backup', '💾 Backup Service')], default='primary', help_text='Role of service in group', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['plan_type', 'is_active'], name='provisionin_plan_ty_15481c_idx'), models.Index(fields=['is_public', 'is_active'], name='provisionin_is_publ_eadfc0_idx')],
            },
        ),
        migrations.AddField(
            model_name='service',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relationship_type', models.CharField(choices=[('addon', '🔧 Add-on Service'), ('included', '📦 Included Service'), ('dependency', '⚡ Required Dependency'), ('upgrade', '⬆️ Service Upgrade'), ('bundle', '🎁 Bundle Component')], help_text='Type of service relationship', max_length=20)),
                ('billing_impact', models.CharField(choices=[('separate', '💳 Billed Separately'), ('included', '🆓 Included in Parent'), ('discounted', '💰 Discounted Rate'), ('prorated', '📊 Prorated Billing')], default='separate', help_text='How this affects customer billing', max_length=20)),
