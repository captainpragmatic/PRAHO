...
class SecureTaskParameters:
    ...
    def create(cls, parameters: dict[str, Any]) -> SecureTaskParameters:
        ...
        return cls(
            encrypted_payload=encrypted_b64, parameter_hash=parameter_hash, created_at=timezone.now().isoformat()
        )
...
def log_security_event_safe(
    event_type: str, details: dict[str, Any], service_id: str | None = None, domain: str | None = None
) -> None:
    """
