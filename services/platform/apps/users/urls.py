...
urlpatterns = [
    ...
    path("register/submitted/", views.registration_submitted_view, name="registration_submitted"),
    # Password reset
    ...
    path(
        "2fa/method-selection/", views.mfa_method_selection, name="mfa_method_selection"
    ...
    path(
        ...
        views.two_factor_regenerate_backup_codes,
