...
class ProformaInvoice(models.Model):
    ...
    def recalculate_totals(self) -> None:
        ...
        if self.status != "draft":
            raise ValidationError(_("Only a draft proforma can be recalculated."))
        if self.discount_cents:
            raise ValidationError(_("A discounted proforma cannot be recalculated from undiscounted line totals."))
