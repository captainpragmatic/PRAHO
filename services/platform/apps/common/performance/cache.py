...
class CacheService:
    ...
    def _queryset_count_key(self, queryset: models.QuerySet[Any]) -> str:
        ...
        query_hash = hashlib.md5(sql.encode()).hexdigest()[:12]  # noqa: S324  # Safe: cache key hashing, not cryptographic
...
def get_cache_service() -> CacheService:
    ...
    global _cache_service  # noqa: PLW0603  # Module-level singleton pattern
...
def cached_queryset(
    ...
    def decorator(func: Callable[..., Any]) -> Callable[..., list[Any]]:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> list[Any]:
            ...
            key_hash = hashlib.md5(key.encode()).hexdigest()[:16]  # noqa: S324  # Safe: cache key hashing, not cryptographic
