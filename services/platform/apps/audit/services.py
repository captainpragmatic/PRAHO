...
class ProductsAuditService:
    ...
    def log_product_pricing_changed(  # audit trail fields  # noqa: PLR0913  # Business logic parameters
        ...
        pricing_metadata = {
            ...
            "changes": changes,
            "current_pricing": {
                "monthly_price_cents": product_price.monthly_price_cents,
                "monthly_price": float(product_price.monthly_price),
                ...
                "semiannual_discount_percent": float(product_price.semiannual_discount_percent),
...
class DomainsAuditService:
    ...
    def log_domain_event(  # Domain audit requires multiple domain-specific parameters  # audit trail fields  # noqa: PLR0913  # Business logic parameters
        ...
        domain_metadata = {
            ...
            "domain_lock_status": domain.locked,
            "customer_id": str(domain.customer.id) if domain.customer else None,
            "nameservers": domain.nameservers if domain.nameservers else [],
