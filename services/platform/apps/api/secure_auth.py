...
def _uniform_error_response(
    message: str = "Access denied", status_code: int = 403, extra_headers: dict[str, Any] | None = None
) -> Response:
    """
    ...
    return Response({"success": False, "error": message}, status=status_code, headers=headers)
