...
Examples:
    ...
    parser.add_argument("--check-all", action="store_true", help="Check all Python files in apps/")
    parser.add_argument(
        "--allow-legacy", action="store_true", help="Allow type ignore in legacy modules during transition"
    )
    parser.add_argument(
    ...
    # Initialize checker
    checker = TypeIgnoreChecker(allow_legacy=args.allow_legacy, strict_mode=not args.no_strict)
