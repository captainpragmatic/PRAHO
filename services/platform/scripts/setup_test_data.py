...
MULTI_REPLY_CONVERSATION_COUNT = 5
...
def create_test_data() -> (  # Complexity: multi-step business logic
    ...
    with transaction.atomic():
        ...
        if created:
            # SECURITY: test fixture with hardcoded password — not user-facing
            customer_user.set_password(  # nosemgrep: unvalidated-password
                "admin123"
            )
            customer_user.save()
        ...
        # Use update_or_create so is_primary=True is enforced on re-runs
...
def create_products_if_missing() -> (  # Complexity: multi-step business logic
    ...
    try:
        ...
        ron_currency, _ = Currency.objects.get_or_create(code="RON", defaults={"symbol": "LEI", "decimals": 2})
        eur_currency, _ = Currency.objects.get_or_create(code="EUR", defaults={"symbol": "€", "decimals": 2})
    ...
    try:
        ...
        for i, ticket_data in enumerate(tickets_data, 1):
            ...
            if created:
                ...
                elif ticket_data["replies"] == MULTI_REPLY_CONVERSATION_COUNT:
...
def print_credentials(  # Complexity: multi-step business logic
    ...
    try:
        ...
        if products_count == 0:
            print("   ➡️  Create products via Admin: http://localhost:8701/admin/products/product/")
    except ImportError:
        pass
    ...
    try:
        ...
        if services_count == 0:
            print("   ➡️  Create services via Admin: http://localhost:8701/admin/provisioning/service/")
    except ImportError:
        pass
    ...
    try:
        ...
        if invoices_count == 0:
            print("   ➡️  Create invoices via Admin: http://localhost:8701/admin/billing/invoice/")
    except ImportError:
        pass
