...
class RefundServiceTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.customer = Customer.objects.create(
            name="Test Company", customer_type="company", company_name="Test Company", status="active"
        )

        # Create customer tax profile
        self.customer_tax_profile = CustomerTaxProfile.objects.create(
            customer=self.customer, cui="12345678", vat_number="RO12345678"
        )
...
class TestRefundServiceWithFixtures:
    ...
    def setup_refund_test_data(self):
        ...
        return {"user": user, "customer": customer, "currency": currency}
    ...
    def test_concurrent_refund_processing(self, setup_refund_test_data):
        ...
        Payment.objects.create(
            ...
            amount_cents=10000,
            currency=data["currency"],
            gateway_txn_id="test_txn_concurrent",
        )
