...
> **Pre-release software (v0.18.0-alpha)** - Under active development. Not yet recommended for production use.
...
[![DCO](https://github.com/captainpragmatic/PRAHO/actions/workflows/dco-check.yml/badge.svg)](https://github.com/captainpragmatic/PRAHO/actions/workflows/dco-check.yml)
...
This project follows [Semantic Versioning](https://semver.org/). Current version: **v0.18.0** (alpha).
