...
> **Pre-release software (v0.19.0-alpha)** - Under active development. Not yet recommended for production use.
...
This project follows [Semantic Versioning](https://semver.org/). Current version: **v0.19.0** (alpha).
